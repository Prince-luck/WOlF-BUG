...
//time
const xtime = moment.tz('Nigeria/Lagos').format('HH:mm:ss')
        const xdate = moment.tz('Nigeria/Lagos').format('DD/MM/YYYY')
        const time2 = moment().tz('Nigeria/Lagos').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
                ...
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://telegra.ph/file/9d13c17dbd6154c7f8b35.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on GITHUB`,
                            thumbnailUrl: 'https://telegra.ph/file/9d13c17dbd6154c7f8b35.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
